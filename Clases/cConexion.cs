...
namespace Proyecto_Movilidad.Clases
{
    internal class cConexion
    {
        ...
        static private string cadenaconecion = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename='D:\Documents\ProyectoPOO\Proyecto_Movilidad\dbMovilidad.mdf';Integrated Security=True;connect Timeout=30";
